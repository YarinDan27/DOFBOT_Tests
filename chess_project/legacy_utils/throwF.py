...
class DOFBOTController:
    ...
    def throw_sequence(self):
        ...
        # Step 4: Wind back for throw - AWAY FROM JETSON NANO!
        print("Step 4: Winding back for throw (AWAY from Jetson Nano)")
        windup_position = {
            'base': 45,        # Turn base AWAY from Jetson Nano
            'shoulder': 150,   # Pull shoulder UP and back (not down toward Nano!)
            'elbow': 45,       # Bend elbow up and back
            'wrist_pitch': 45, # Angle wrist up and back
            'wrist_roll': 90,  # Keep wrist straight
        ...
        throw_position = {
            'base': 135,       # Swing base to opposite side for throw
            'shoulder': 60,    # Swing shoulder forward and down
            'elbow': 150,      # Extend elbow forward
            'wrist_pitch': 140 # Snap wrist forward and down
        }
        ...
        followthrough_position = {
            'base': 135,       # Complete the rotation away from Nano
            'shoulder': 90,    # Continue forward motion
            'elbow': 160,      # Full extension
            'wrist_pitch': 150 # Complete wrist snap
        }
